...
' Date	: January 2018
'
' Start Excel, open a file and add a reference to a given .xlam file
...
Sub ShowHelp()
	...
	wScript.echo " ==========================================="
	wScript.echo " = Excel - Add a reference to a .xlam file ="
	wScript.echo " ==========================================="
	wScript.echo ""
...
Dim sFile
	...
	Else
		...
		' Now remove the reference if already there
		Call cMSExcel.References_Remove("CAVO_AddIn")

		' And add a new one
		Call cMSExcel.References_AddFromFile("C:\Temp\a\PROD_CAVO_AddIn.xlam")
